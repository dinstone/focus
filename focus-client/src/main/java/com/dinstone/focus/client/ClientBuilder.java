...
public class ClientBuilder {
    ...
    private ClientEndpointOption endpointOption = new ClientEndpointOption();
    ...
    public Client build() {
        return new Client(endpointOption, serviceAddresses);
    }

    public ClientBuilder endpointConfig(ClientEndpointOption endpointOption) {
        if (endpointOption != null) {
            this.endpointOption.setEndpointId(endpointOption.getEndpointId());
            this.endpointOption.setEndpointName(endpointOption.getEndpointName());
            this.endpointOption.setDefaultTimeout(endpointOption.getDefaultTimeout());
            this.endpointOption.setTransportConfig(endpointOption.getTransportConfig());
            this.endpointOption.setRegistryConfig(endpointOption.getRegistryConfig());
        }
    ...
    public ClientBuilder transportConfig(TransportConfig transportConfig) {
        this.endpointOption.setTransportConfig(transportConfig);
        return this;
    }

    public ClientBuilder registryConfig(RegistryConfig registryConfig) {
        this.endpointOption.setRegistryConfig(registryConfig);
        return this;
    }
