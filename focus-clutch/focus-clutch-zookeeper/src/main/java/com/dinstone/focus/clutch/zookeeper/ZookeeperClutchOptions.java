...
public class ZookeeperClutchOptions implements ClutchOptions {
    ...
    public ZookeeperClutchOptions setZookeeperNodes(String zookeeperNodes) {
    ...
    public ZookeeperClutchOptions setConfigPath(String configPath) {
    ...
    public ZookeeperClutchOptions setBaseSleepTime(int baseSleepTime) {
    ...
    public ZookeeperClutchOptions setMaxRetries(int maxRetries) {
