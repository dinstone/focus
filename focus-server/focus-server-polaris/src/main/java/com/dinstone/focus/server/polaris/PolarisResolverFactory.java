...
public class PolarisResolverFactory implements ResolverFactory {

    @Override
    public boolean applicable(ResolverOptions options) {
        return options instanceof PolarisResolverOptions;
    }

    @Override
    public ServiceResolver create(ResolverOptions options) {
        return new PolarisServiceResolver((PolarisResolverOptions) options);
    }
